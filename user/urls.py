...
urlpatterns = [
    ...
    ########### User Edit Delete Retrive################################
    path('user-profile', views.UserProfile.as_view(), name="user-profile"),
    path('edit-profile/<int:id>', views.EditUserView.as_view(), name="edit-profile"),
    path('user-delete/<int:id>', views.UserDeleteView.as_view(), name="user-delete"),
    ########### User Edit Delete Retrive################################
